                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-grid">
                                ...
                                <form action="<?php echo e(route('reservas.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\reseva_salas\resources\views/reservas/create.blade.php ENDPATH**/ ?>