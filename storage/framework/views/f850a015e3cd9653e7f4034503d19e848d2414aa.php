                            ...
                            <div class="mt-3 mt-lg-0">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="data_hora_inicio" type="datetime-local"
                                           value="<?php echo e(date('Y-m-d\TH:i', strtotime(@$reservas->data_hora_inicio))); ?>" id="datetime1" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mt-3 mt-lg-0">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="data_hora_fim" type="datetime-local"
                                           value="<?php echo e(date('Y-m-d\TH:i', strtotime(@$reservas->data_hora_fim))); ?>" id="datetime2" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="descricao_pedido" rows="2" placeholder="Descrição do pedido" disabled><?php echo e(@$reservas->descricao_pedido); ?></textarea>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\reseva_salas\resources\views/reservas/form-show.blade.php ENDPATH**/ ?>